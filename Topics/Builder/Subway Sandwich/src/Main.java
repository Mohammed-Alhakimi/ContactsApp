...
class Sandwich {
    ...
    private Sandwich(String bun, int salad, int cheese, int cucumber, int ham) {
        this.bun = bun;
        this.salad = salad;
        this.cheese = cheese;
...
class TestDrive {
    public static void main(String[] args) {
        ...
        Sandwich sandwich = new Sandwich.Builder().addBun(bun).addHam(ham).addCheese(cheese).addCucumber(cucumber).addSalad(salad).build(); /* write your code here */
